...
public class DarkCustomMode extends AppCompatActivity {
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dark_custom_mode);
    ...
    {
        Intent i=new Intent(DarkCustomMode.this,Game.class);
        recreate();
    }
    ...
    public void jumpdialog()
    {
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DarkCustomMode.this, DarkMainActivity.class);
                startActivity(i);
                finish();
            }
        });
