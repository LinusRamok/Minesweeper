...
public class CustomMode extends AppCompatActivity {
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s=getIntent().getStringExtra("Mi");
        String sr=getIntent().getStringExtra("R");
        String sc=getIntent().getStringExtra("C");
        totalmines=Integer.parseInt(s);
        flagcount=totalmines;
        rows=Integer.parseInt(sr);
        cols=Integer.parseInt(sc);
            ...
            public boolean onLongClick(View v) {
                if (flagstop != 1) {
                    if ((mirror[curr][curc] == 0) || (mirror[curr][curc] == 2)) {
                        button[curr][curc].setBackgroundResource(R.drawable.customflag);
                        matrix[curr][curc] = 1;
                        ...
                        button[curr][curc].setBackgroundResource(R.drawable.custombackeasy);
    ...
    public void setMines(int currentRow,int currentColumn) {
        for (int i = 0; i < totalmines; i++) {
            ...
            int k,l;
            k=random.nextInt(rows);
            l=random.nextInt(cols);
    ...
    {
        Intent i=new Intent(CustomMode.this,Game.class);
        recreate();
    }
    ...
    public void jumpdialog()
    {
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CustomMode.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void pausemethod()
    {
        if (ispauseClickable == true) {
            ...
            tv38.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(CustomMode.this, InGameHighScore.class);
                    startActivity(i);
                }
            });
            ...
            tv39.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(CustomMode.this, InGameHowToPlay.class);
                    startActivity(i);
                }
            });
