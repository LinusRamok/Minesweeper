...
public class SurvivalMode extends AppCompatActivity {
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(totalmines==10) {
            rl.setBackgroundResource(R.drawable.mainbackeasy);
            sp=60;

            txtTimer.setText("60.0");
        }
        else if(totalmines==16) {
            rl.setBackgroundResource(R.drawable.mainbackmedium);
            sp=100;

            txtTimer.setText("100.0");
        }
        else if(totalmines==23) {
            rl.setBackgroundResource(R.drawable.mainbackhard);
            sp=130;

            txtTimer.setText("130.0");
        }
        else if(totalmines==38) {
            rl.setBackgroundResource(R.drawable.mainbackinsane);
            sp=150;

            txtTimer.setText("150.0");
        }
   ...
   /* void calculatehighscore(double gs )
            ...
            public boolean onLongClick(View v) {
                if (flagstop != 1) {
                    if ((mirror[curr][curc] == 0) || (mirror[curr][curc] == 2)) {
                        button[curr][curc].setBackgroundResource(R.drawable.flag);
                        matrix[curr][curc] = 1;
                        ...
                        button[curr][curc].setBackgroundResource(R.drawable.backeasy);
        ...
        for (int currentRow = 0; currentRow < 12; currentRow++) {
            for (int currentColumn = 0; currentColumn < 8; currentColumn++) {
                ...
                if (mirror[currentRow][currentColumn] == 2 && matrix[currentRow][currentColumn] != 2) {
                    ...
                    mirror[curr][curc] = 1;
                    button[curr][curc].setBackgroundResource(R.drawable.mine);
                }
                if(mirror[currentRow][currentColumn]==0){
                    button[currentRow][currentColumn].setBackgroundResource(R.drawable.endgamebackground);
                    endcolor(currentRow,currentColumn);
                }
                if(matrix[currentRow][currentColumn]==1 && mirror[currentRow][currentColumn]!=2)
                {
                    button[currentRow][currentColumn].setBackgroundResource(R.drawable.wrongflag);
                }
    ...
    {
        Intent i=new Intent(SurvivalMode.this,Game.class);
        recreate();
    }
            ...
            for (int j=0;j<8;j++) {
                ...
                if (dummy[curr][curc]!=0 && mirror[curr][curc]==0)
                {
...

                    {
                        ...
                        case 1:
                            button[curr][curc].setBackgroundResource(R.drawable.openbackground);
                            ...
                            public void onClick(View v) {
                                ...
                                if (matrix[M][N] != 1 && matrix[M][N]!=2 && mirror[M][N]==0)
                                {
...

                                    {
                                        ...
                                        case 1:
                                            button[M][N].setBackgroundResource(R.drawable.openbackground);
    ...
    public void showBox(int curr,int curc) {
        ...
        if (mirror[i][j] != 2 && dummy[i][j] == 0 ) {
            ...
            mirror[i][j] = 1;
            count++;
            button[i][j].setBackgroundResource(R.drawable.openbackground);
    ...
    public void endcolor(int i, int j) {
...

        {
            ...
            case 1:
                button[curr][curc].setBackgroundResource(R.drawable.endgamebackground);
                button[curr][curc].setText("1");
                button[curr][curc].setTextSize(28);
                button[curr][curc].setTextColor(Color.CYAN);
                break;
    ...
    public void jumpdialog()
    {
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SurvivalMode.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void pausemethod()
    {
        if (ispauseClickable == true) {
            ...
            tv38.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(SurvivalMode.this, InGameHighScore.class);
                    startActivity(i);
                }
            });
            ...
            tv39.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(SurvivalMode.this, InGameHowToPlay.class);
                    startActivity(i);
                }
            });
