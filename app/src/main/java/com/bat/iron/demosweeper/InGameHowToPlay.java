...
public class InGameHowToPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* tv10=(TextView)findViewById(R.id.textView10);
        ...
        View v1=li.inflate(R.layout.htp1,null);
        tv10=(TextView) v1.findViewById(R.id.textView10);
        tv11=(TextView) v1.findViewById(R.id.textView11);*/
