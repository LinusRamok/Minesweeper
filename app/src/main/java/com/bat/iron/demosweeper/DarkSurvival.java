...
public class DarkSurvival extends AppCompatActivity {
   ...
   */
   ...
   /* void calculatehighscore(double gs )
    ...
    {
        Intent i=new Intent(DarkSurvival.this,Game.class);
        recreate();
    }
    ...
    public void jumpdialog()
    {
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DarkSurvival.this, DarkMainActivity.class);
                startActivity(i);
                finish();
            }
        });
