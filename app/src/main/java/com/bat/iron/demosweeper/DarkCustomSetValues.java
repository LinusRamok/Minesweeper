...
public class DarkCustomSetValues extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dark_custom_set_values);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DarkCustomSetValues.this,DarkCustomMode.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        check=1;
        Intent i = new Intent(DarkCustomSetValues.this,DarkMainActivity.class);
        startActivity(i);
    }
}
