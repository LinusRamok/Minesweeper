...
public class DarkSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (p.equals("1"))
                {
                    Intent i = new Intent(DarkSettings.this,DarkAboutUs.class);
                    startActivity(i);
                }
                else if (p.equals("0"))
                {
                    Intent i = new Intent(DarkSettings.this,AboutUs.class);
                    startActivity(i);
                }
            }
        });
    ...
    public void onBackPressed() {
        ...
        if (p.equals("1"))
        {
            Intent i = new Intent(DarkSettings.this,DarkMainActivity.class);
            startActivity(i);
            finish();
        }
        else if (p.equals("0"))
        {
            Intent i = new Intent(DarkSettings.this,MainActivity.class);
            startActivity(i);
            finish();
        }
    }
